    ...
    if (d.children) {
        ...
        if (!d.children) {
            ...
            y.innerHTML =
                ...
                "<p>" + d.claimReason + "</p>" +
                "<a  href='../curriculum/overview/" + d.ma + "'> * Xem Chi Tiết Thông Tin Chung </a>" + "</br>" +
                "<a  href='../curriculum/list/" + d.ma + "' > * Xem Nội Dung Chương Trình Đào Tạo </a>"
        }
    }
    clearAll(root);
    update(d);
...
d3.json("http://localhost:51198/home/mmap", function (error, values) {
//d3.json(
